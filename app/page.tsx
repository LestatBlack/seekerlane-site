  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-[40vh] pb-24">
        ...
        {/* CONTACT */}
        <section id="contact" className="relative min-h-[120vh] scroll-mt-24">
          <div className="lg:sticky top-24">
            <div className="rounded-3xl p-8 sm:p-10 bg-white/5 ring-1 ring-white/10 shadow-xl backdrop-blur">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">Contact</h2>
              <p className="text-slate-300 mb-6">
                Tell us what you need (role, stack, seniority, budget, timeline).
                We’ll send a shortlist quickly.
              </p>
