        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
          <div className="grid items-center gap-8 lg:grid-cols-2">
            <div className="order-2 space-y-4 lg:order-1">
              <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">SeekerLane</h1>
              <p className="lg:hidden text-base sm:text-lg text-slate-300">LatAm reach • US standards</p>
              <div className="flex flex-wrap gap-3 pt-2">
                <Link href="/#services" className="rounded-xl px-5 py-3 bg-indigo-600 text-white font-medium hover:bg-indigo-700">
                  Our Services
                </Link>
                <Link href="/jobs" className="rounded-xl px-5 py-3 bg-slate-100 text-slate-900 font-medium hover:bg-slate-200">
                  Browse Jobs
                </Link>
              </div>
            </div>
          ...
          <div className="lg:sticky top-24">
            <div className="rounded-3xl p-8 sm:p-10 bg-white/5 ring-1 ring-white/10 shadow-xl backdrop-blur">
              ...
              <p className="text-slate-300 leading-relaxed">
                We connect top LATAM engineers and tech talent with US-quality processes: structured interviews, clear SLAs,
                fast shortlists, and weekly reporting.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="lg:sticky top-24">
            <div className="rounded-3xl p-8 sm:p-10 bg-gradient-to-br from-indigo-600/20 to-fuchsia-600/20 ring-1 ring-white/10 shadow-xl backdrop-blur">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link href="/#contact" className="rounded-xl px-5 py-3 bg-indigo-600 text-white font-medium hover:bg-indigo-700">
                  Get a proposal
                </Link>
                <Link href="/jobs" className="rounded-xl px-5 py-3 bg-slate-100 text-slate-900 font-medium hover:bg-slate-200">
                  Browse Jobs
          ...
          <div className="lg:sticky top-24">
            <div className="rounded-3xl p-8 sm:p-10 bg-white/5 ring-1 ring-white/10 shadow-xl backdrop-blur">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="mailto:hello@seekerlane.com" className="rounded-xl px-5 py-3 bg-indigo-600 text-white font-medium hover:bg-indigo-700">
                  Email Us
                </a>
                <Link href="/contact" className="rounded-xl px-5 py-3 bg-slate-100 text-slate-900 font-medium hover:bg-slate-200">
                  Open Contact Page
                </Link>
              </div>
            </div>
